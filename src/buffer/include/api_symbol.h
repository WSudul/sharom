//this is copy-paste. Make it common file for all subprojects exporting c api
//todo: remove below defines and make it cmpile time thing in Cmake
#define SHAROM_SYMBOL
#define SHAROM_SYMBOL_EXPORTS
